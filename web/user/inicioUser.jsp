...
<html>
    ...
    <body>
        <div class="container">
            ...
            %>
            <br>
            <h2>Usuario: <%= usuario.getUsername() %></h2>
            <%
                }
            %>
        </div>
    ...
    <script>
        ...
        var authenticated = <%= request.getSession().getAttribute("authenticated") != null && (Boolean) request.getSession().getAttribute("authenticated") %>;
